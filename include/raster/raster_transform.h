...
void rtransform_set_rotation_axis_angle(rtransform_t* transform, vec3 axis, float angle);v
oid rtransform_set_rotation_quat(rtransform_t* transform, quat rotation);
